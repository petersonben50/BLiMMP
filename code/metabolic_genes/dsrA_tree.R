#### code/metabolic_analyses/dsr/dsr_tree.R ####
# Benjamin D. Peterson
...
#### Read in tree ####
dsrA.tree.unrooted <- read.newick(file = "dataEdited/metabolic_analyses/dsr/dsrA_phylogeny_trimmed.tree")
...
pdf("dataEdited/metabolic_analyses/dsr/dsrA_tree_original_unrooted.pdf",
    width = 12,
    height = 120)
...
pdf("dataEdited/metabolic_analyses/dsr/dsrA_tree_original_rooted.pdf",
    width = 12,
    height = 120)
ggtree(dsrA.tree) +
  geom_tiplab(size = 2) +
...
dsrA.list <- readLines("dataEdited/metabolic_analyses/dsr/dsrA_list.txt")
...
writeLines(rdsr.list,
           "dataEdited/metabolic_analyses/dsr/dsrA_rev_list.txt")
...
writeLines(red.dsrA,
           "dataEdited/metabolic_analyses/dsr/dsrA_red_list.txt")
