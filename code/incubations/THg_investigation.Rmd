...
When cleaning the THg data, I noticed that the values were highly, highly variable, much more so that we would expect.
I wanted to investigate this, and see if I could figure out what was going on.


So, I wanted to look at the ratios of 204Hg to 198Hg.
