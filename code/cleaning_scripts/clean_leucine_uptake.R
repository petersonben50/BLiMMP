...
incubation.data.20191014 <- leucine.data.temp %>%
  ...
  # But, this is how people have been calculating it forever, so I'm gonna stick with it. At some
...
WC.data.20190831 <- WC.data.20190831 %>%
  left_join(metadata.WC)
