...
# Three sequences, very close to Firmicutes group above. However, one was binned as Desulfomonilaceae. I'll put it under Desulfobacterales.
Desulfo_group <- c("BLI21_coassembly_000000025634_9", "BLI21_coassembly_000000086306_5", "BLI21_coassembly_000000502164_1")
taxonomic_grouping_hgcA[Desulfo_group] <- "Desulfobacterales"
...
# hgcA sequences within a big cluster of reference sequences that are Desulfobacterales
desulfo_group_2 <- tree_subset(hgcA.tree,
  ...
  strsplit(":") %>% sapply("[", 1) %>%
  grep("BLI", ., value = TRUE)
taxonomic_grouping_hgcA[desulfo_group_2] <- "Desulfobacterales"
